...
<div style="text-align: center;"> 
 ...
 <a href="${path}/admin/write.do">상품등록</a>
  ...
  <a href="${path}/pdf/list.do">PDF</a>
   ...
   <a href="${path}/chart/chart1.do"> 구글차드 (json)</a>
   <a href="${path}/chart/chart2.do"> 구글차트 (database)</a>
   <a href="${path}/jchart/chart1.do">jFreeChart(png)</a>
   <a href="${path}/jchart/chart2.do"> JFREEChart</a>
 ...
 <div style="text-align: right;">
   <c:choose>   
    ...
    <!-- 로그인 하지 않은 상태 --> 
  <a href="${path}/member/login.do">일반로그인</a> |   
